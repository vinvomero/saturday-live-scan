...
export const concordFaq: FaqItem[] = [
  ...
  {
    q: 'Cash or card?',
    a: 'Most shops in this table list cash plus card options on DOJ. Postal Annex #164 lists cash and debit but no Credit Cards on DOJ. Certifix UPS #0075 lists cash, checks, credit, and debit but no Billing Accounts. DOJ says to check for payment restrictions. Confirm with the shop before you go.',
  },
  {
    q: 'Are UPS store hours the fingerprint hours?',
    a: 'No. UPS pages advertise shipping / notary hours. Live Scan Saturday hours are the DOJ column. UPS #0854 also lists Sunday Walk-ins & Appointments on DOJ (10:30 am – 3:30 pm). UPS #7668 lists Sunday Walk-ins & Appointments on DOJ (11:00 am – 4:00 pm). Certifix at UPS #0075 lists Sunday Walk-ins on DOJ (11:00 am – 4:00 pm). That is fingerprint hours from DOJ, not a promise that every UPS service is open.',
  },
  {
    q: 'Why isn\'t JoAnn Cosme / AlKaabi / Johanna Torres on this list?',
    a: 'JoAnn Cosme Tax & Notary is Saturday appointment only on DOJ. AlKaabi, Beta Identify, ERSIC, and Seek & Find are Saturday or Weekends appointment only (and DOJ lists city-only Concord with no street for those four). Legal Office of Johanna Torres PC is weekday-only on DOJ. This page is Saturday walk-in only (accessed 2026-09-05).',
  },
  {
    q: 'Do I get the results?',
    a: 'No. Results go to the requesting agency, not to you. Keep the yellow copy / ATI number.',
  ...
  {
    q: 'What\'s the cheapest / earliest Saturday walk-in in Concord?',
